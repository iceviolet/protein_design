...
void Design(Vergil* vergil) {
	...
	std::string input_directory =
			"/Users/Violet/data/peptide_design/tetramer_29/fullseq_design_approved_by_Jeff";
	std::string output_directory =
			"/Users/Violet/data/peptide_design/2D_lattice/C4459/P222/P222_9";
  ...
  fclose(outfile);
	...
	for (double a = 24.7; a < 30.2; a += 0.1) {
		for (double c = 29.7; c < 37.1; c += 0.1) {
		  for (double beta = 1; beta < 91; ++beta) {
        // Load scaffold
        ...
        //To-do: move the domain(ASU) to the correct position in the unit cell
